...
class ErrorResponse(BaseModel):
    ...
    message: str = Field(description="Message to be shown to end user",
...
class BaseVirtolifyException(Exception):
    def __init__(self, error_code: str, message: str, status_code=status.HTTP_500_INTERNAL_SERVER_ERROR):
...
def setup_exception_handlers(app):
    app.add_exception_handler(BaseVirtolifyException,
                              virtolify_exception_handler)
